            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Chuyển nhân viên</h1>
                        ...
                        <div class="card-body">
                            <form action="ChuyenNhanVien" method="post">
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="MaNhanVien" type="text" name="MaNhanVien" value="${dao.getUser(param.id).maNhanVien}" placeholder="Mã nhân viên" readonly=""/>
                                    <label for="MaNhanVien">Tài khoản /Mã nhân viên</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="HoTen" type="text" name="HoTen" value="${dao.getUser(param.id).hoTen}" placeholder="Mã nhân viên" readonly=""/>
                                ...
                                <table class="" border="0">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select class="form-control" id="PhongBanCu" name="PhongBanCu">
                                                    <option class="dropdown-item" value="${dao.getPhongBan(param.dep).maPhongBan}">${dao.getPhongBan(param.dep).tenPhongBan}</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><h6>Phòng ban chuyển đến&emsp;<h6/></td>
                                            <td>
                                                <select class="form-control" id="PhongBanChuyenDen" name="PhongBanChuyenDen">
                                        ...
                                        <tr>
                                            <td><h6>Lý do&emsp;<h6/></td>
                                            <td>
                                                <textarea class="form-control" name="LyDo" placeholder=""></textarea>                                                  
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
